...
# ==========================================
# EXPANDED STOCK DATA (35+ per industry)
# ==========================================

INDUSTRIES = {
    "💻 Technology": [
        "AAPL", "MSFT", "NVDA", "GOOGL", "META", "ADBE", "CRM", "ORCL", "IBM", "CSCO",
    ...
    "🛒 Retail": [
        "WMT", "AMZN", "COST", "TGT", "HD", "LOW", "TJX", "ROST", "DG", "DLTR",
        "KSS", "M", "JWN", "BBY", "ULTA", "EL", "LULU", "GPS", "GAP", "AEO",
        "ANF", "URBN", "WSM", "RH", "TPR", "RL", "KORS", "CPRI", "LEVI", "VFC",
        "ETSY", "WAYF", "CHWY", "PETZ", "WOOF"
    ],
    "💊 Healthcare": [
        "JNJ", "PFE", "MRK", "ABBV", "UNH", "CVS", "CI", "HUM", "ELV", "ANTM",
        "MCK", "ABC", "CAH", "BMY", "GILD", "AMGN", "REGN", "VRTX", "BIIB", "MRNA",
        "ILMN", "DHR", "TMO", "WAT", "PKI", "MTD", "A", "ABT", "MDT", "ISRG",
        "SYK", "EW", "BSX", "ZBH", "HCA"
    ],
    "🍔 Consumer Goods": [
        "PG", "KO", "PEP", "MCD", "SBUX", "NKE", "DIS", "MMM", "CL", "KMB",
        "PM", "MO", "MDLZ", "KHC", "GIS", "HSY", "CAG", "CPB", "K", "STZ",
        "BFB", "TAP", "SAM", "CELH", "MNST", "COST", "WMT", "TGT", "UL", "NSRGY",
        "PEP", "KO", "MDLZ", "KHC", "CAG"
    ],
    "🔌 Energy": [
        "XOM", "CVX", "COP", "SLB", "EOG", "PXD", "OXY", "KMI", "MPC", "PSX",
        "VLO", "HES", "KOS", "DVN", "FANG", "MRO", "APA", "CHK", "SWN", "RRC",
        "WMB", "OKE", "TRGP", "ENB", "EPD", "MPLX", "PAA", "AA", "BKR", "HAL",
        "NOV", "WFT", "OII", "FTI", "SPN"
    ],
    "🏗️ Industrials": [
        "GE", "CAT", "BA", "LMT", "RTX", "HON", "UNP", "UPS", "FDX", "DE",
        "MMM", "DOW", "DD", "HWM", "ITW", "PH", "CMI", "CARR", "OTIS", "KBE",
        "EMR", "ROK", "DHR", "TMO", "WAT", "PKI", "MTD", "A", "ABT", "MDT",
        "ISRG", "SYK", "EW", "BSX", "ZBH"
    ],
    "📞 Telecom": [
        "VZ", "T", "TMUS", "CHTR", "CMCSA", "DISH", "ATNI", "LUMN", "USM", "IHS",
        "VOD", "BT", "DTE", "ORAN", "TLK", "TEF", "AMX", "NTT", "KDDI", "SBA",
        "CCI", "AMT", "SBAC", "IRDM", "GILT", "CLWR", "LEO", "LBTYA", "LBTYK", "TKA",
        "TDS", "SHEN", "CNSL", "FTR", "WTT"
    ],
    "🧪 Biotech": [
        "AMGN", "GILD", "BIIB", "REGN", "VRTX", "MRNA", "IONS", "ALNY", "NBIX", "EXEL",
        "INCY", "BMRN", "HZNP", "UTHR", "SAGE", "SRPT", "PTCT", "RARE", "FGEN", "ARWR",
        "LGND", "MYGN", "QLGN", "BYSI", "OVID", "ABCL", "ACAD", "ADMA", "AGEN", "ALEC",
        "ALKS", "ALLO", "ALNY", "ALT", "AMPH"
    ],
    "🏠 Real Estate": [
        "AMT", "PLD", "EQIX", "PSA", "VICI", "WELL", "SPG", "O", "DLR", "AVB",
        "EQR", "INVH", "ESS", "MAA", "SUI", "ARE", "VTR", "PGR", "UDR", "CPT",
        "REG", "FRT", "KIM", "VNO", "SLG", "BXP", "WPC", "STAG", "EPRT", "COLD",
        "CUBE", "EXR", "LAMR", "NLY", "AGNC"
    ],
    "⚡ Semiconductors": [
        "NVDA", "AMD", "INTC", "TSM", "AVGO", "QCOM", "TXN", "AMAT", "LRCX", "KLAC",
        "ADI", "NXPI", "MCHP", "ON", "SWKS", "QRVO", "STM", "MRVL", "MU", "WDC",
        "CDNS", "SNPS", "TER", "ENTG", "LRCX", "AMAT", "KLAC", "TXN", "QCOM", "NVDA",
        "AMD", "INTC", "TSM", "AVGO", "ADI"
    ],
    "📈 Financial Services": [
        "V", "MA", "PYPL", "SQ", "FIS", "FISV", "GPN", "DFS", "AXP", "COF",
        "SYF", "ALLY", "SOFI", "UPST", "AFRM", "LEND", "MARA", "RIOT", "HOOD", "COIN",
        "SPGI", "MCO", "MSCI", "IQV", "NDAQ", "ICE", "CME", "CBOE", "MORN", "BAM",
        "BLK", "STT", "BK", "JHG", "TROW"
    ],
    "🏥 Medical Devices": [
        "MDT", "SYK", "BSX", "ISRG", "ABT", "EW", "ZBH", "BSC", "CI", "HUM",
        "DVA", "HCA", "UHS", "THC", "CYH", "BDX", "DXCM", "MASI", "TNDM", "INMD",
        "PODD", "STE", "HOLX", "VAR", "NVST", "ENOV", "GMED", "ATRC", "CNMD", "MMSI",
        "HALO", "ICUI", "NEOG", "NTRA", "PRVA"
    ]
}
...
def get_sentiment(title):
    ...
    positive_words = ['surge', 'beat', 'up', 'gain', 'record', 'strong', 'positive', 'growth', 
                     ...
                     'buy', 'upgrade', 'outperform', 'initiate', 'reiterate', 'bullish']
    negative_words = ['drop', 'fall', 'down', 'loss', 'cut', 'negative', 'weak', 'decline', 
                     'risk', 'concern', 'plunge', 'slump', 'fall', 'low', 'miss', 'delay',
                     'sell', 'downgrade', 'underperform', 'bearish', 'investigation', 'lawsuit']
...
def analyze_stock(ticker):
    ...
    try:
        ...
        return {
            ...
            'rating': '❌ No Data',
            'color': 'red',
            'mom_advice': 'Could not fetch data for this stock',
            'pe': None,
            'pe_status': '❌ No data',
            'debt_status': '❌ No data',
...
def display_stock_card(row, show_news=True):
    ...
    if not row.get('has_data', True):
        st.warning(f"⚠️ {row['ticker']}: No data available")
        return
...
with st.sidebar:
    ...
    **10% Lynch** — Keep it simple! Buy what you know
    ...
    st.header("⚙️ Filters")
    min_score = st.slider("Minimum Score", 0, 6, 2, help="Only show stocks with this score or higher")
    show_only_good = st.checkbox("Show only 'Buy' & 'Good' ratings", value=False)
...
st.write(f"**📊 {len(stocks)} stocks in {selected_industry}**")

# --- Analyze All Stocks in Industry ---
col1, col2, col3 = st.columns([2, 1, 1])
with col1:
    analyze_btn = st.button(f"🔍 Analyze All {len(stocks)} Stocks", use_container_width=True)
with col2:
    show_news_toggle = st.checkbox("Show News", value=True)
with col3:
    sort_by = st.selectbox("Sort by:", ["Score (High to Low)", "Score (Low to High)", "Name (A-Z)", "Safety Score", "Quality Score"])

if analyze_btn:
    with st.spinner(f"Fetching data for {len(stocks)} stocks... this takes 15-30 seconds..."):
        results = []
        ...
        if sort_by == "Score (High to Low)":
            ...
            df = df.sort_values('fisher_score', ascending=False)
        
        # --- Display Results ---
        st.success(f"✅ Analysis complete! Found {len(df)} stocks matching your criteria")
        ...
        if len(df) == 0:
            ...
            with col4:
                best_graham = df.iloc[df['graham_score'].argmax()]['ticker']
                st.metric("Safest", best_graham)
            with col5:
                best_fisher = df.iloc[df['fisher_score'].argmax()]['ticker']
                st.metric("Highest Quality", best_fisher)
    ...
    st.info(f"👆 Click the button above to analyze all {len(stocks)} stocks in this industry!")
...
# ==========================================
# HELPER: Display term definitions
# ==========================================

def display_term_definitions():
    """Display all term definitions in a clean format"""
    st.write("### 📖 Financial Terms Explained")
    for term, explanation in EXPLANATIONS.items():
